...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col md:flex-row justify-center items-center gap-8 mt-20 md:mt-28">
      <div className="flex flex-col justify-center items-center lg:flex-row max-w-7xl gap-10">
        <div className="max-w-xs md:max-w-lg flex flex-col gap-4">
        ...
        <Image
          ...
          alt="Working girl turned Superhero, Image Generated by Grok from xAI"
        />
      </div>
    </section>
  );
